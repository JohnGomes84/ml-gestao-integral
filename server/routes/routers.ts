...
export const appRouter = router({
  ...
  allocations: router({
    ...
    suggestWorkers: protectedProcedure
      ...
      .query(async ({ input }) => {
        ...
        const sorted = workersWithRisk.sort(
          (a, b) => a.risk.score - b.risk.score
        );
  ...
  supervisor: router({
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        if (location) {
          ...
          if (allocation && allocation.locationId) {
            const workLocation = await db.getLocationById(
    ...
    checkOut: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const mealCost = allocation.tookMeal
          ? parseFloat(allocation.mealCost || "0")
          : 0;
  ...
  reports: router({
    ...
    biweeklyReport: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await db.getBiweeklyReport(
          input.year,
          input.month,
          input.period,
          input.clientId
  ...
  operations: router({
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas administradores podem criar operações",
          });
        }
    ...
    listByLeader: protectedProcedure.query(async ({ ctx }) => {
    ...
    getById: protectedProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        if (ctx.user.role === "leader" && operation.leaderId !== ctx.user.id) {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Você não é o líder desta operação",
          });
        }
    ...
    start: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "leader" && ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas líderes podem iniciar operações",
          });
        }
    ...
    checkIn: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "leader" && ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas líderes podem fazer check-in",
          });
        }
    ...
    checkOut: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "leader" && ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas líderes podem fazer check-out",
          });
        }
    ...
    complete: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "leader" && ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas líderes podem completar operações",
          });
        }
    ...
    createIncident: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "leader" && ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas líderes podem registrar ocorrências",
          });
        }
  ...
  compliance: router({
    ...
    blockWorker: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas administradores podem bloquear trabalhadores",
          });
        }
    ...
    unblockWorker: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        if (ctx.user.role !== "admin") {
          throw new TRPCError({
            code: "FORBIDDEN",
            message: "Apenas administradores podem desbloquear trabalhadores",
          });
        }
    ...
    checkExpiredBlocks: protectedProcedure.mutation(async ({ ctx }) => {
      if (ctx.user.role !== "admin") {
        throw new TRPCError({ code: "FORBIDDEN" });
      }
    ...
    getConsecutiveDays: protectedProcedure
      ...
      .query(async ({ input }) => {
        const consecutiveDays = await db.calculateConsecutiveDays(
          input.workerId,
          input.clientId
        );
        return {
    ...
    getLowAutonomyWorkers: protectedProcedure.query(async ({ ctx }) => {
      if (ctx.user.role !== "admin") {
        throw new TRPCError({ code: "FORBIDDEN" });
      }
    ...
    calculateRisks: protectedProcedure.query(async ({ ctx }) => {
      if (ctx.user.role !== "admin") {
        throw new TRPCError({ code: "FORBIDDEN" });
      }
